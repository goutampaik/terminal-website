...
function commander(cmd) {
    switch (cmd.toLowerCase()) {
        ...
        case "ddcroadmapphase1":
            ...
            break;
        case "ddcroadmapphase2":
            loopLines(ddcroadmapphase2, "color2 margin", 80);
            break;
        case "ddcroadmapphase3":
            loopLines(ddcroadmapphase3, "color2 margin", 80);
            break;
        case "team":
            loopLines(team, "color2 margin", 80);
            break;
        case "ddcgame":
            loopLines(ddcgame, "color2 margin", 80);
            break;
        case "ddcpublicsale":
            loopLines(ddcpublicsale, "color2 margin", 80);
            break;
        case "ddcprivatesale":
        ...
        case "email":
            addLine('Opening mailto:<a href="mailto:goutampaik752@gmail.com">Goutam Paik</a>...', "color2", 80);
            newTab(email);
            break;
        case "clear":
            setTimeout(function () {
